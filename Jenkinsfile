pipeline
{
    ...
    stages
    {
	    ...
	    stage ('helm charts')
		{
		    ...
		    {
		        sh '''
		            kubectl create namespace abhishekgoyal-samplejava
		            helm install devops-helm-java mychart-java --set image=dtr.nagarro.com:443/my-app:${BUILD_NUMBER} -n abhishekgoyal-samplejava 
		        '''
		    }
		}
    }
